...
<head>
    ...
    <title>Wordle Juegos Dificil</title>
</head>
    ...
    <body>
        <main class="container">
            <div class="container align-items-center justify-content-center">
                <h1 class="mt-5">Wordle videojuegos</h1>
                <div class=" tutorial row justify-content-center text-center p-3">
                    <h3><strong> Las reglas son sencillas. Tendrás que adivinar el juego misterioso letra por letra en
                            ...
                            <ul>
                                ...
                                <li style="color: red;">Letra roja: El juego no contiene esa letra.</li>
                            </ul>
                            ¡Buena suerte en tu búsqueda del juego misterioso!
                        </strong>
                    </h3>
                </div>
        ...
        <script src="./javascript/wordlejuegodificil.js"></script>
    </body>
